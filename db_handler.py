...
def UploadFaceEntity(entity_id,  app_key, base_64_data):
    data = {
        'Action': 'AddFace',
        'URL': URl,
        'DbName': 'default',
...
def show_face_detail():
    ...
    basic_info = GetEntityInfo(ei, app_key)
...
def upload_face():
    ...
    UploadFaceEntity(entity_id, app_key, base_64_data)
    return ("success")
